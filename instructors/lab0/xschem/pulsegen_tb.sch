...
.endc
"}
C {devices/launcher.sym} -900 60 0 0 {name=h1 descr="Netlist & Simulate"
...
C {devices/vsource.sym} 620 300 0 0 {name=Vdd value=1.8}
C {devices/lab_pin.sym} 620 270 0 0 {name=l_vdd lab=vdd}
C {devices/gnd.sym} 620 330 0 0 {name=g2 lab=0}
C {devices/vsource.sym} 800 300 0 0 {name=Vss value=0}
C {devices/lab_pin.sym} 800 270 0 0 {name=l_vss lab=vss}
C {devices/gnd.sym} 800 330 0 0 {name=g3 lab=0}
